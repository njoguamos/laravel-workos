...
WorkOs has an official [Laravel PHP SDK](https://github.com/workos/workos-php-laravel) which is build on top of the [WorkOS PHP SDK](https://workos.com/docs/sdks/php). These official SDKs are great and provide a lot of features. You are more than welcome to use them of the meet your needs.
